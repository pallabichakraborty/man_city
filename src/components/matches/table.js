        ...
        pos ?
            pos.map((pos,i)=>(
                <TableRow key={i}>
                    ...
                    <TableCell align="right" style={style.cell}>{pos.w}</TableCell>
                    <TableCell align="right" style={style.cell}>{pos.d}</TableCell>
                    <TableCell align="right" style={style.cell}>{pos.l}</TableCell>
                    <TableCell align="right" style={style.cell}>{pos.pts}</TableCell>
                </TableRow>
            ))
            :null
    )
